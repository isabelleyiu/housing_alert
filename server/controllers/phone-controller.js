...
const register = (req, res) => { 
  ...
  .then(([phone, created]) => {
    if(created) {
      phone.dataValues.message = `Thank you for registering your number! Please enter the verification code we texted to ${phone} to complete the registration process`
