...
class App extends Component {
  ...
  loadGoogleMap = () => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyCt1a2aohx-NonwFex5Xt5vK9mgOI7t2f4`;
    script.async = true;
    script.defer = true;
  ...
  loadGapiAndAfterwardsInitAuth = () => {
    ...
    meta.content =
      '471876448199-rbr3jioupfcqkgvgisrbflvgb5q1q7ns.apps.googleusercontent.com';
      ...
      window.gapi.auth2
        ...
        .then(() => {
          ...
          const googleUserInfo =
            this.auth.currentUser.get().getBasicProfile() || null;
          this.setState({
