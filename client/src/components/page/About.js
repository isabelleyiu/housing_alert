  ...
  render() {
    return (
      <div className="about">
        ...
        <IconContext.Provider  value={{ color: "green", fontSize: "4rem"}}>
          <div style={{marginTop: "40px", marginBottom: "40px"}}>
            <IoIosPhonePortrait style={{height: "200px", width: "200px"}}/>
            <span><strong>Step 1: </strong> Enter your phone number above to register with Housing Alert.</span>
          </div>
          <div>
            <IoIosColorWand style={{height: "200px", width: "200px"}}/>
